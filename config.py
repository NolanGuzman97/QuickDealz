#DB_PASSWORD = os.getenv('DB_PASSWORD', urllib.parse.quote_plus('P@ssw0rd'))
#DB_PASSWORD = os.getenv('DB_PASSWORD', urllib.parse.quote_plus('P@ssw0rd'))
...
class Development(Config):
    ...
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_USER', "quickdealz.dev.service@gmail.com")
    MAIL_USERNAME = os.getenv('MAIL_USER', "quickdealz.dev.service@gmail.com")
    MAIL_PASSWORD = os.getenv('MAIL_PASSWORD', "P@ssw0rd123!")
